...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                description.set("The plugin that allowed to set values in resource files")
                licenses {
                    license {
                        name.set("MIT")
                        url.set("https://raw.githubusercontent.com/artfable/gradle-resource-plugin/master/LICENSE")
